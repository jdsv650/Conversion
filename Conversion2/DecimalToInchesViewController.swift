...
class DecimalToInchesViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int)
    {
        ...
        //if pickerView.isEqual(num1Picker)
       // {
        ...
        let number1AsInteger = (number1AsString as NSString).integerValue
            decimal1AsString = "\(number1AsString).\(num1Picker.selectedRowInComponent(4))"
       // }
       // else
       // {
            ...
            let number2AsInt = (number2AsString as NSString).integerValue
            
            let number2AsInteger = (number2AsString as NSString).integerValue
              decimal2AsString = "\(number2AsString).\(num2Picker.selectedRowInComponent(4))"
       // }
        
        var num1AsDouble = (decimal1AsString as NSString).doubleValue
        var num2AsDouble = (decimal2AsString as NSString).doubleValue

        var result = num1AsDouble - num2AsDouble
        
        var rounded = roundToPlaces(result, places: 5)
